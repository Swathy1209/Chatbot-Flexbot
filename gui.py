...
class ChatbotGUI:
    ...
    def setup_gui(self):
        ...
        self.master.configure(bg="#fefefe")
        ...
        self.chat_history = scrolledtext.ScrolledText(main_frame, wrap=tk.WORD, width=60, height=25, font=("Arial", 10))
    ...
    def load_chatbot_data(self):
        ...
        self.intents = json.loads(open("C:/Users/swathiga/Downloads/Chatbot/Data/intents.json").read())  # Make sure the path is correct
    ...
    def get_bot_response(self, user_message):
        if user_message.lower() in ["exit", "quit", "bye"]:
            ...
            intent = self.predict_class(user_message)
    ...
    def predict_class(self, sentence):
        ...
        return [self.classes[r[0]] for r in results]
